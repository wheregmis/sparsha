...
use sparsh_signals::{Effect, Memo, Signal};
use sparsh_widgets::{BuildContext, BuildStateStore, IntoWidget, Theme, Widget};
use std::any::Any;
    ...
    W: IntoWidget,
{
    ...
    fn paint(&self, _ctx: &mut sparsh_widgets::PaintContext) {}
    ...
    fn component_signal_state_survives_host_recreation_at_same_path() {
        ...
        runtime.run_with_current(|| {
            ...
            for expected in [0usize, 1usize] {
                ...
                build.set_path(&[0]);
                build.set_state_store(&mut store);
